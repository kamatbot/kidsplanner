...
enum Palette {
    ...
    static let frHw = Color.adaptive(Color(hex: 0xF5821F), Color(hex: 0xFF9A3C))
    static let frHwInk = Color.adaptive(Color(hex: 0xB0540A), Color(hex: 0xFFC185))
    static let frHwSoft = Color.adaptive(Color(hex: 0xFFF3E3), Color(hex: 0xFF9A3C, alpha: 0.14))
    ...
    // Shared colours keep their own values; they are not ring categories.
    static let coral = Color.adaptive(Color(hex: 0xE8467C), Color(hex: 0xFF6F9D))
    static let orange = coral
    static let orangeInk = Color.adaptive(Color(hex: 0xB8205A), Color(hex: 0xFF9CBB))
    static let warn = frFamsInk
    static let blue = Color.adaptive(Color(hex: 0x4B7BF5), Color(hex: 0x7EA3FF))
    static let teal = Color.adaptive(Color(hex: 0x0EA58C), Color(hex: 0x2FD3B4))
