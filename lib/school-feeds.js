...
const BUILTIN_FEEDS = [
  {
    ...
    calendarId: "standrews.ac.th_a25bgo8dl9bcggkqtvbdg73rpg",
  ...
  },
  {
    ...
    calendarId: "standrews.ac.th_o9pe6t3oi3lmn9u9hme5ujo95s",
    mapsTo: "school events",
    deadline: false,
  },
  {
    ...
    calendarId: "41753qg2fl7ii5mk5g2r5jj41c",
  ...
  },
  {
    ...
    calendarId: "standrews.ac.th_83llb0e0nai91e7iui5pl8uadk",
    mapsTo: "deadlines",
    deadline: true,
  },
  {
    ...
    calendarId: "standrews.ac.th_lk64660d4utn2agjlp99nnkb7o",
    mapsTo: "deadlines",
    deadline: true,
  },
  {
    ...
    calendarId: "standrews.ac.th_urlaprs6nnhf1vkct73creehd4",
    mapsTo: "deadlines",
    deadline: true,
  },
];
...
function famStore(familyId) {
  ...
  if (!r.schoolCalendar[familyId]) {
    r.schoolCalendar[familyId] = { subscriptions: [], cache: {}, lastSyncAt: null };
  }
...
async function fetchIcsText(url) {
  ...
  try {
    const res = await fetch(url, { signal: controller.signal, headers: { "User-Agent": "FamETC-School-Sync/1.0" } });
