"use strict";
/**
 * The SAT vocabulary words for the "word of the day" / word bank feature —
...
// ponytail: the original 30-word calendar also seeds saved crosswords. Expand
// the daily rotation only alongside a versioned puzzle/progress migration.
const DAILY_WORDS = WORDS.slice(0, 30);
module.exports = { WORDS, DAILY_WORDS };
