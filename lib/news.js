...
const FEEDS = Object.freeze([
  ...
  { url: "https://live.firstnews.co.uk/feed/", source: "First News", hosts: ["firstnews.co.uk"], production: true, defaultCategory: "Culture" },
  { url: "https://www.eco-business.com/feeds/news/", source: "Eco-Business", hosts: ["eco-business.com"], production: true, defaultCategory: "🌿 Environment", topicFilter: /\b(?:youth|young|student|school|tech\w*|innovation|solar|robot\w*|electric|engineer\w*|digital|data cent\w*|hydrogen)\b/i },
...
const SOURCE_NOTES = Object.freeze([
  ...
  { source: "The Week Junior", status: "Dedicated current article feed not verified; First News is the active alternative." },
