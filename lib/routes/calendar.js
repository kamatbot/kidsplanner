...
module.exports = (app, deps) => {
  const { schoolFeeds, homework, events, chat, trips, requireAuth, requireParent, requireFamily, userRole, kidIdForUser, friendlyDate } = deps;
  ...
  app.get("/api/calendar/events", requireAuth, requireFamily, (req, res) => {
    ...
    res.json({ events: list.concat(tripCalendarEvents(req)) });
  });
