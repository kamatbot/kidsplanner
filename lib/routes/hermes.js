...
module.exports = (app, deps) => {
  ...
  function operatorErrorStatus(error) {
    ...
    if (["OPERATOR_EXECUTION_UNAVAILABLE", "OPERATOR_STORAGE_UNAVAILABLE", "OPERATOR_MEMORY_UNAVAILABLE", "OPERATOR_ATTACHMENT_UNAVAILABLE", "OPERATOR_SHADOW_UNAVAILABLE"].includes(code)) return 503;
    if ([
      ...
      "OPERATOR_SHADOW_PARENT_REQUIRED", "OPERATOR_SHADOW_ACTOR_DENIED",
