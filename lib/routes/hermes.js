...
module.exports = (app, deps) => {
  ...
  function operatorErrorStatus(error) {
    ...
    if (["OPERATOR_EXECUTION_UNAVAILABLE", "OPERATOR_STORAGE_UNAVAILABLE", "OPERATOR_MEMORY_UNAVAILABLE", "OPERATOR_ATTACHMENT_UNAVAILABLE"].includes(code)) return 503;
    if ([
    ...
    if (["OPERATOR_CASE_NOT_FOUND", "APPROVAL_NOT_FOUND", "OPERATOR_FAMILY_NOT_FOUND", "OPERATOR_MEMORY_NOT_FOUND", "OPERATOR_ATTACHMENT_NOT_FOUND"].includes(code)) return 404;
    return 400;
  }
