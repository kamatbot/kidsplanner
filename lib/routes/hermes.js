...
module.exports = (app, deps) => {
  ...
  // Hermes adapter/tests. Canonical Family Context v1 is now authoritative;
  // these aliases are read-only compatibility projections during the adapter
  // migration and are derived exclusively from the canonical sections.
