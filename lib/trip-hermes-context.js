...
function recentConversation(tripId) {
  ...
  // The datastore returns oldest-to-newest. Fill the aggregate budget from the
  // newest end so the triggering @Hermes turn and the latest crew decisions
  // are never displaced by older conversation, then restore chat order.
