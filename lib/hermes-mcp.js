...
const SERVER_INSTRUCTIONS = "Use FamETC tools only for the authenticated family. Create a durable case for multi-step work. Every tool requires the actorToken attached to the initiating FamETC message; never invent an actor or reuse authority from another message. Request approval before irreversible external actions.";
