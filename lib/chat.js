...
function validateMedia(scopeKey, media) {
  if (!media || typeof media !== "object") return null;
  if (media.type === "attachment") {
    try { return chatAttachments.validateMediaForScope(scopeKey, media); } catch (e) { return null; }
  }
...
function sendMessage(scopeKey, { senderType, senderId, postedByUserId, text, card, media, buzz }) {
  ...
  const validMedia = isBuzz ? null : validateMedia(scopeKey, media);
